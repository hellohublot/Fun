//
//  HTDiscoverHomeRankNavigationBar.swift
//  Live
//
...
class HTDiscoverHomeRankNavigationBar: UIView {
	...
	lazy var selectedButton: UIButton = {
		...
		button.setImage(UIImage.init(named: "b936b4d69cc41b1fd8f87f99f8359899"), for: .normal)
		button.ht_makeEdge(with: .horizontal, imageToTitleaOffset: -5)
		button.setTitle("日榜", for: .normal)
		return button
	}()
