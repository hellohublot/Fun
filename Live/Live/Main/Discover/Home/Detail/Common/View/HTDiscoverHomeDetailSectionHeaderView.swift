//
//  HTDiscoverHomeDetailSectionHeaderView.swift
//  Live
//
...
class HTDiscoverHomeDetailSectionHeaderView: UICollectionReusableView, ReuseCell {
	...
	func setModel(_ model: Any?, for indexPath: IndexPath) {
		guard let model = model as? HTDiscoverHomeDetailSectionModel else {
			return
		}
