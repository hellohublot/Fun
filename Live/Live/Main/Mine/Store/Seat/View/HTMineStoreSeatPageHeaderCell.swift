//
//  HTMineStoreSeatPageHeaderCell.swift
//  Live
//
...
class HTMineStoreSeatPageHeaderCell: UICollectionViewCell, ReuseCell {
	...
	func setModel(_ model: Any?, for indexPath: IndexPath) {
		guard let model = model as? HTMineStoreSeatPageModel else {
			return
		}
