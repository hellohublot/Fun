//
//  HTMineStoreSeatPageHeaderView.swift
//  Live
//
...
class HTMineStoreSeatPageHeaderView: UICollectionReusableView, ReuseCell {
...
extension HTMineStoreSeatPageHeaderView: CollectionViewThrough, UICollectionViewDelegateFlowLayout {
	
	func cellClass<T>(_ reuseView: T, for indexPath: IndexPath) -> ReuseCell.Type where T : ReuseAbleView {
		return HTMineStoreSeatPageHeaderCell.self
	}
