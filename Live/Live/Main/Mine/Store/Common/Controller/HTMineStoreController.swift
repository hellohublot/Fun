...
class HTMineStoreController: UIViewController {
	
	let pageModelArray = HTMineStorePageModel.packModelArray()

	lazy var navigationBar: HTMineStoreNavigationBar = {
		let navigationBar = HTMineStoreNavigationBar.init(frame: CGRect.zero)
...
extension HTMineStoreController: HTPageHeaderViewDelegate, HTPageContentControllerDelegate {
