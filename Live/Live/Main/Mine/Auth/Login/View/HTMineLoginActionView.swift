...
class HTMineLoginActionView: UIView {
	...
	lazy var protocolButton: UIButton = {
        ...
        let attributedString: NSAttributedString = {
            ...
            attributedString.append(NSAttributedString.init(string: "登录即代表同意 ", attributes: [
	...
	override init(frame: CGRect) {
		...
		protocolButton.snp.makeConstraints { (maker) in
			maker.left.equalTo(20)
			maker.right.equalTo(-20)
			maker.top.equalTo(loginButton.snp.bottom).offset(16)
		}
	}
