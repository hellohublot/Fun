...
class HTMineGuardController: UIViewController {

	let pageModelArray = HTMineGuardPageModel.packModelArray()
	
	lazy var navigationBar: HTMineGuardNavigationBar = {
		let navigationBar = HTMineGuardNavigationBar.init(frame: CGRect.zero)
...
extension HTMineGuardController: HTPageHeaderViewDelegate, HTPageContentControllerDelegate {
