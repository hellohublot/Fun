//
//  HTDiscoverRecommendBillCell.swift
//  Music163
//
...
class HTDiscoverRecommendBillCell: UICollectionViewCell, ReuseCell {
	...
	func setModel(_ model: Any?, for indexPath: IndexPath) {
		guard let model = model as? HTDiscoverRecommendBillModel else {
			return
		}
