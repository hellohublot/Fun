...
class HTVideoNavigationBar: UIView {
	...
	lazy var recordButton: UIButton = {
		...
		let image = UIImage.init(named: "bddb0a166f7a7fc3dc1fc7fcdcefd213")
	...
	lazy var searchButton: UIButton = {
		...
		button.setTitle("给你推荐 男孩", for: .normal)
	...
	override init(frame: CGRect) {
		...
		navigationContentView.addSubview(recordButton)
		...
		searchButton.snp.makeConstraints { (maker) in
			maker.left.equalTo(recordButton.snp.right).offset(5)
